...
You can create such a `.osrm.*` dataset by running the OSRM binaries we ship in `node_modules/@project-osrm/osrm/lib/binding/` and default
profiles (e.g. for setting speeds and determining road types to route on) in `node_modules/@project-osrm/osrm/profiles/`:

    node_modules/@project-osrm/osrm/lib/binding/osrm-extract data.osm.pbf -p node_modules/@project-osrm/osrm/profiles/car.lua
    node_modules/@project-osrm/osrm/lib/binding/osrm-contract data.osrm
